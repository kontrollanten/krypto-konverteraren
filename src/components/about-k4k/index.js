...
export default () => (
  <ContentWrapper textContent>
    ...
    <p>Exempel: du köpte ETH för BTC den 9 mars. Du måste då redogöra för vad BTC stod i SEK samt vad ETH stod i SEK den 9 mars.</p>
